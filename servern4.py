...
def generar_respuesta_premium(mensaje: str, historial: list, estado: dict) -> dict:
    try:
        ...
        if not estado.get("nombre"):
            respuesta = "¡Hola! Bienvenido a Volkswagen Eurocity Culiacan. Soy Alex, tu asistente de ventas. ¿Cuál es tu nombre y buscas un auto nuevo o usado?"
            ...
            # Filtrar modelos según tipo_vehiculo
            modelos_por_tipo = {
